...
//         <li>
//           <NavLink className="collapsed" data-bs-toggle="collapse" to="#collapse00" aria-expanded="false">
//             <span>Caribbean Premier League</span>
//             <i className="bi bi-caret-down ms-auto"></i>
//           </NavLink>
//           <div id="collapse00" className="collapse">
//             <ul className="nav-second-level">
//               <li>
//                 <NavLink className="final-link">
//                   <span>Caribbean Premier League</span>
//                 </NavLink>
//               </li>
//               <li>
//                 <NavLink className="final-link">
//                   <span>Barbados Royals v Trinbago Knight Riders</span>
//                 </NavLink>
//               </li>
//               <li>
//                 <NavLink className="final-link">
//                   <span>St. Lucia Kings v Antigua And Barbuda Falcons</span>
//                 </NavLink>
//               </li>
//             </ul>
//           </div>
...
const CricketNavigation = () => {
  ...
  // Function to toggle the collapse of sections
  const toggleCollapse = (sectionId) => {
    setCollapsedSections((prevState) => ({
      ...prevState,
      [sectionId]: !prevState[sectionId],
  ...
  // Fetch cricket matches from the API
  useEffect(() => {
    const fetchMatches = async () => {
      try {
        const response = await axios.get("https://api.cricapi.com/v1/currentMatches?apikey=3b25de51-8538-4074-96b9-f0ecf29d2196&offset=0");
      ...
      {matches.map((match, index) => (
        <li key={match.id}>
          <NavLink
            ...
            to="#"
          >
            <span>{match.name || "Match " + (index + 1)}</span>
            <i className={`bi bi-caret-down ms-auto arrow ${collapsedSections[`collapse${index}`] ? 'rotate-180' : ''}`}></i>
          </NavLink>
          {collapsedSections[`collapse${index}`] && (
            <ul className="nav-second-level">
              {/* Render additional match details if available */}
              <li><NavLink to="#">{match.name || "Match Details"}</NavLink></li>
              {/* Add more match details if available */}
            </ul>
          )}
        </li>
      ))}
